...
public class ProductsCheckAdapter extends ArrayAdapter<Product> {
    ...
    public ProductsCheckAdapter(Context context, int resource, List<Product> Products) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            TextView name = (TextView) convertView.findViewById(R.id.product_item_check_text);
